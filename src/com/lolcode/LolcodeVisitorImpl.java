...
public class LolcodeVisitorImpl<T> extends lolcodeBaseVisitor<T> {
    ...
    @Override public T visitVisstat(lolcodeParser.VisstatContext ctx) {
    ...
    @Override public T visitNotexpr(lolcodeParser.NotexprContext ctx) {
    ...
    @Override public T visitMinmaxexpr(lolcodeParser.MinmaxexprContext ctx) {
...
//        LolVariable vars[] = new LolAbstractVariable[ctx.formalParameters().getChildCount()/2];
    ...
    @Override public T visitEquexpr(lolcodeParser.EquexprContext ctx) {
    ...
    @Override public T visitMultexpr(lolcodeParser.MultexprContext ctx) {
        System.out.println(ctx.getChild(3).getText());
        LolVariable lhs = (LolVariable)visit(ctx.getChild(1));
        LolVariable rhs = (LolVariable)visit(ctx.getChild(3));
        LolVariable tmp = new LolAbstractVariable(String.valueOf(currentFunction.symbols.size()+1), "FUCK_THIS_SHIT");
        currentFunction.addVariable(tmp);
